...
export PATH
pwd=$1
mysql -u root -e 'use mysql;update user set plugin="mysql_native_password";';
mysql -u root -e "CREATE USER 'root'@'localhost' IDENTIFIED BY 'Master@786';FLUSH PRIVILEGES;"
mysql -u root -e "CREATE USER 'admin'@'localhost' IDENTIFIED BY 'Master@786';FLUSH PRIVILEGES;"
