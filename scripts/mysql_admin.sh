...
export PATH
pwd=$1
mysql -u root -e "CREATE USER 'root'@'localhost' IDENTIFIED BY 'Default@password';FLUSH PRIVILEGES;"
mysql -u root -e "CREATE USER 'admin'@'localhost' IDENTIFIED BY 'Default@password';FLUSH PRIVILEGES;"
mysql -u root -e "alter user 'root'@'localhost' identified by 'Default@password';FLUSH PRIVILEGES;"
